...
const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASS}@cluster0.ynhrrkd.mongodb.net/?retryWrites=true&w=majority`;
...
app.get("/", (req, res) => {
  res.send("Cake hut is ready");
});

app.listen(port, () => {
  console.log(`Cake Hut is sitting on port ${port}`);
});